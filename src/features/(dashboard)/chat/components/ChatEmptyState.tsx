...
export function ChatEmptyState({ isGroupsFilter, onCreateGroup }: ChatEmptyStateProps) {
    if (isGroupsFilter) {
        return (
            <div className="flex-1 flex flex-col items-center justify-center h-full bg-gray-50/30 p-6 md:p-8">
                <div className="max-w-md text-center space-y-4 md:space-y-6">
                    <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-blue-5 flex items-center justify-center mx-auto">
                        <Users className="w-8 h-8 md:w-10 md:h-10 text-blue-3" />
                    </div>
                    <h2 className="text-xl md:text-2xl font-bold text-gray-800">لا توجد مجموعات</h2>
                    <p className="text-sm md:text-base text-gray-500">قم بإنشاء مجموعة جديدة للتواصل مع عدة مستخدمين</p>
                    <Button
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center h-full bg-gray-50/30 p-6 md:p-8">
            <div className="max-w-md text-center space-y-6 md:space-y-8">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800">نصائح عامة</h2>
