        ...
        <table className="w-full min-w-[720px]">
          <thead>
            <tr className="bg-gray-50 border-b border-gray-100 text-right">
              <th className="px-6 py-4 text-start text-sm font-bold text-gray-500 w-[30%] min-w-[220px] whitespace-nowrap">عنوان المقال</th>
                ...
                <td className="px-6 py-4">
                  <div className="flex items-center justify-center gap-1.5 whitespace-nowrap">
                    <Button
                      ...
                      title="تعديل"
                    >
                      <Image src="/icons/dashboard/edit3.svg" alt="تعديل" width={16} height={16} className="w-4 h-4" />
                    </Button>
                    <Button
                      variant="ghost"
                      size="icon"
                      ...
                      title="حذف"
                    >
                      <Image src="/icons/dashboard/trash.svg" alt="حذف" width={16} height={16} className="w-4 h-4" />
                    </Button>
                    <Button
                      variant="ghost"
                      size="icon"
