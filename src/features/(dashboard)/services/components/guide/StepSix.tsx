    ...
    return (
        <div className="w-full">
            ...
            <div className="hidden lg:block relative w-full max-w-[1336px] min-h-[500px] mx-auto ">
                ...
                <p className="absolute text-[#2D496A] text-xs md:text-sm font-medium leading-relaxed text-right top-[44%] left-[66.7%] max-w-[10%]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <div className="flex flex-col gap-3 order-1">
                        <img
                            ...
                            loading="lazy"
                        />
                         <p className="text-xs md:text-sm text-[#2D496A] font-medium text-center"> سيتم نشر الخدمة عند الموافقة عليها من فريق أعطيني المختص  </p>
                    </div>             
                </div>
            </div>
        </div>
