    ...
    return (
        <div className="w-full">
            ...
            <div className="hidden lg:block relative w-full max-w-[1336px] min-h-[400px] mx-auto ">
                ...
                <p className="absolute text-[#5B7C93] text-xs leading-relaxed text-right top-[87.3%] left-[67.5%] max-w-[35.1%]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                    <div className="flex flex-col gap-3 order-1">
                        <img
                            ...
                            loading="lazy"
                        />
                        <p className="text-xs md:text-sm text-[#5B7C93] font-medium text-center">  أضف عدة صور لتوضيح خدمتك، واختر صورة أساسية لأنها ستكون الصورة الظاهرة للمستخدم عند تصفح الخدمات. </p>
