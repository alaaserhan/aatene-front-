        ...
        <div className="grid grid-cols-12 gap-6 mt-8">
          ...
          <div className="col-span-12 lg:col-span-8">
            <div className="bg-white rounded-xl p-8 border border-gray-200 shadow-sm space-y-8">
              ...
              <h2 className="text-xl font-bold text-gray-900 text-right">نهائياً</h2>

              {/* Copyright Notice */}
              <div className="space-y-2">
                <h3 className="text-lg font-bold text-gray-900">إشعار حقوق النشر</h3>
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-gray-900">شروط الخدمة</h3>
                <div className="flex items-start gap-3">
                  <div className="relative flex items-center">
                    <input
                      ...
                      className="peer h-5 w-5 cursor-pointer appearance-none rounded-md border border-gray-300 transition-all checked:border-blue-4 checked:bg-blue-4 hover:border-blue-4 focus:ring-2 focus:ring-blue-4/20"
                    />
                  ...
                  <label htmlFor="terms" className="text-sm text-gray-500 cursor-pointer select-none">
                    أفهم وأوافق على شروط خدمة اعطيني، بما في ذلك <Link href="#" className="text-[#3A5779] underline hover:text-blue-600">اتفاقية المستخدم</Link> و<Link href="#" className="text-[#3A5779] underline hover:text-blue-600">سياسة الخصوصية</Link>.
                  </label>
                </div>
              </div>
              ...
              {/* Privacy Notice */}
              <div className="space-y-4">
                <h3 className="text-lg font-bold text-gray-900">إشعار الخصوصية</h3>
                <div className="flex items-start gap-3">
                  <div className="relative flex items-center">
                    <input
                      type="checkbox"
