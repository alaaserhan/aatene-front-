// src/features/(dashboard)/products/components/sections/ProductSubmitBar.tsx
"use client";
...
/**
 * Sticky bottom bar for the single-page product form: cancel at the start,
 * submit at the end. Mirrors StoreSubmitBar so both flows feel the same.
 */
export function ProductSubmitBar({
  ...
  return (
    <div
      className={cn(
        "sticky bottom-0 left-0 right-0 z-30 w-full bg-white shadow-[0_-4px_20px_rgba(0,0,0,0.08)]",
        className
      )}
    >
