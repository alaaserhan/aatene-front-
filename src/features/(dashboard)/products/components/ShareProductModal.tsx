// src/features/(dashboard)/products/components/ShareProductModal.tsx
"use client";
...
import { Copy, X, Facebook, Twitter, Instagram } from "lucide-react";
...
export function ShareProductModal({
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      href: "#", // Instagram doesn't have a direct web share link usually
    },
    {
      name: "WhatsApp",
      icon: WhatsAppIcon, // Custom SVG component below
      color: "text-[#25D366]",
