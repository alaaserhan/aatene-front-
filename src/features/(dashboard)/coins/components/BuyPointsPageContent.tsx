                            ...
                            {packages.map((pkg) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="text-3xl font-medium mb-1 text-blue-4">{pkg.coins_count}</div>
                                        <div className="text-xs text-gray-2 mb-4">عملة ذهبية</div>
                                        <div className="text-xl font-medium">{parseFloat(pkg.price)} ₪</div>
                                    </div>
                                );
                            })}
                        </div>
                ...
                <div className="lg:col-span-4 space-y-6">
                    ...
                    <Card className="border-none shadow-none bg-white overflow-hidden sticky top-4">
                        <CardContent className="p-4 space-y-6">
                            <h2 className="text-xl font-medium">ملخص الطلب</h2>
                            <div className="space-y-4">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg flex items-center gap-3 border border-gray-100">
                                <div className="text-sm text-gray-2">رصيدك بعد الشراء سيصبح</div>
                    ...
                    >
                        {isPurchasing ? (
                            <><Loader2 className="mr-2 h-5 w-5 animate-spin" />جاري المعالجة...</>
                        ) : (
                            <>ادفع الآن</>
                        )}
                    </Button>
