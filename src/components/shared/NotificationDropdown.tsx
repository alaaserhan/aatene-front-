...
import { NavIconBadge, NavIconButton } from "@/src/components/(web)/NavIconButton";
            ...
            <PopoverTrigger asChild>
                {variant === "dashboard" ? (
                    <Button
                        variant="ghost"
                        size="icon"
                        className="rounded-lg text-c2-navy-700 outline-none hover:bg-white/20 relative cursor-pointer"
                    ...
                    <NavIconButton count={unreadCount} aria-label="الإشعارات">
            ...
            >
                <div className="p-2">
                    <div className="flex items-center justify-between">
                        ...
                        {unreadCount > 0 && (
                            <Badge variant="secondary" className="bg-c2-neutral-300-a10 text-c2-primary">
                                {unreadCount} جديد
                            </Badge>
                        )}
                    </div>
